...
public class clawSmallTilt {
    ...
    public static final float TRANSFER = 136f;//188f;//183f;//177f;//171f;//175f;
    public static final float SPEC = 147f;//140f;//117f;//158f;
    public static final float BUCKET = 145f;//175f;//52f;
    public static final float WALL = 137f;
