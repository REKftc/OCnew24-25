...
public class vSlides {
    ...
    public static int high2 = 990;//1410;
    public static int high1 = 590;
    public static int mid = 300;
    public static int stack = 50;//100;
    public static int wall = 85;//200;
    ...
    public vSlides(HardwareMap hardwareMap) {
       ...
       // initialize(this.slideMiddle);
        ...
        RobotLog.ii(TAG_SL, "Initialized the Slide component slideLeft=" + slideLeft.getCurrentPosition() + " slideMiddle=" + " slideRight=" + slideRight.getCurrentPosition());
    }
    ...
    private boolean reachedMaxUpperLimit() {
        ...
        RobotLog.ii(TAG_SL, "reachedMaxUpperLimit() positionL=" + positionL + " positionM=" + " positionR=" + positionR + " max_level_value=" + max_level_value);
        if (positionL > max_level_value || positionR > max_level_value) {
            RobotLog.ii(TAG_SL, "Reached max level positionL=" + positionL + " positionM=" + " positionR=" + positionR + " max_level_value=" + max_level_value);
            return true;
        }
        return false;
    }
    ...
    private boolean isAtLowPosition()
    {
       ...
       // int positionM = slideMiddle.getCurrentPosition();
        int positionR = slideRight.getCurrentPosition();
        RobotLog.ii(TAG_SL, "isAtLowPosition positionL=" + positionL + " positionM=" + " positionR=" + positionR + " SLIDE_SLOW_AT=" + SLIDE_SLOW_AT);
    ...
    private boolean isAlmostBottomPosition()
    {
        ...
        //int positionM = slideMiddle.getCurrentPosition();
        int positionR = slideRight.getCurrentPosition();
        RobotLog.ii(TAG_SL, "isAlmostBottomPosition positionL=" + positionL + " positionM=" + " positionR=" + positionR + " SLIDE_MOREPOWER_AT=" + SLIDE_MOREPOWER_AT);
...
//        }
       ...
       // slideMiddle.setPower(power);
        ...
        RobotLog.ii(TAG_SL, "powerL " + slideLeft.getPower() + " powerM " + " powerR " + slideRight.getPower());
    }
