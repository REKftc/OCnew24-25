package overcharged.pedroPathing.follower;

import static overcharged.pedroPathing.tuning.FollowerConstants.drivePIDFSwitch;
import static overcharged.pedroPathing.tuning.FollowerConstants.forwardZeroPowerAcceleration;
import static overcharged.pedroPathing.tuning.FollowerConstants.headingPIDFSwitch;
import static overcharged.pedroPathing.tuning.FollowerConstants.drivePIDFFeedForward;
import static overcharged.pedroPathing.tuning.FollowerConstants.headingPIDFFeedForward;
import static overcharged.pedroPathing.tuning.FollowerConstants.leftFrontMotorName;
...
import static overcharged.pedroPathing.tuning.FollowerConstants.translationalPIDFFeedForward;
import static overcharged.pedroPathing.tuning.FollowerConstants.lateralZeroPowerAcceleration;
import static overcharged.pedroPathing.tuning.FollowerConstants.secondaryDrivePIDFFeedForward;
import static overcharged.pedroPathing.tuning.FollowerConstants.secondaryHeadingPIDFFeedForward;
import static overcharged.pedroPathing.tuning.FollowerConstants.secondaryTranslationalPIDFFeedForward;
import static overcharged.pedroPathing.tuning.FollowerConstants.translationalPIDFSwitch;
import static overcharged.pedroPathing.tuning.FollowerConstants.useSecondaryDrivePID;
import static overcharged.pedroPathing.tuning.FollowerConstants.useSecondaryHeadingPID;
import static overcharged.pedroPathing.tuning.FollowerConstants.useSecondaryTranslationalPID;
...
import overcharged.pedroPathing.pathGeneration.PathBuilder;
import overcharged.pedroPathing.pathGeneration.PathCallback;
...
import overcharged.pedroPathing.util.DashboardPoseTracker;
import overcharged.pedroPathing.util.Drawing;
import overcharged.pedroPathing.util.FilteredPIDFController;
import overcharged.pedroPathing.util.KalmanFilter;
import overcharged.pedroPathing.util.PIDFController;
